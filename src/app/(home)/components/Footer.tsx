...
const Footer = (props: Props) => {
  ...
  <Image className="absolute bottom-0 left-0" src="https://shuffle.dev/gradia-assets/elements/footers/radial2.svg" width={1000} height={200} alt=""/>
  <div className="container relative z-10 px-4 mx-auto">
    <div className="flex flex-wrap -m-6">
      <div className="w-full p-6 md:w-1/2 lg:w-5/12">
        <div className="flex flex-col justify-between h-full max-w-sm">
          <div className="mb-11">
            <Image src="https://shuffle.dev/gradia-assets/logos/gradia-name-white.svg" width={200} height={40} alt=""/>
          </div>
          <div>
            <p className="text-sm text-gray-200 mb-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pretium dui convallis sagittis tempus mi viverra eget. Quisque justo, blandit orci.</p>
            <p className="text-sm text-gray-400">&copy; Copyright 2022. All Rights Reserved by Gradia.</p>
          </div>
        </div>
      </div>
      <div className="w-full p-6 md:w-1/2 lg:w-2/12">
        <div className="h-full">
          <h3 className="text-base font-medium text-gray-500 mb-7 font-heading tracking-px">Company</h3>
          <ul>
            <li className="mb-4"><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Features</a></li>
            <li className="mb-4"><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Pricing</a></li>
            <li className="mb-4"><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Affiliate Program</a></li>
            <li><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Press Kit</a></li>
          </ul>
        </div>
      </div>
      <div className="w-full p-6 md:w-1/2 lg:w-2/12">
        <div className="h-full">
          <h3 className="text-base font-medium text-gray-500 mb-7 font-heading tracking-px">Support</h3>
          <ul>
            <li className="mb-4"><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Account</a></li>
            <li className="mb-4"><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Help</a></li>
            <li className="mb-4"><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Contact Us</a></li>
            <li><a className="text-base font-medium text-white font-heading hover:text-gray-200" href="#">Customer Support</a></li>
          </ul>
        </div>
      </div>
      <div className="w-full p-6 md:w-1/2 lg:w-3/12">
        <div className="flex flex-col justify-between h-full">
          <div>
            <h3 className="text-base font-medium text-gray-500 mb-7 font-heading tracking-px">Contact Info</h3>
            <ul className="mb-6">
              <li className="mb-4 text-base font-medium text-white font-heading">hi@gradia.com</li>
              <li className="text-base font-medium text-white font-heading">+1 (394) 593 1994</li>
            </ul>
          </div>
